      ...
      <ContentWrapper bgColor="bg-pinjol-light-3">
        ...
        {education && (
          ...
          >
            <Link
              to="/education"
              className="inline-flex items-center text-pinjol-dark-3 hover:text-pinjol-dark-2 mb-6 transition-colors duration-300"
            >
              <i className="fas fa-arrow-left mr-2"></i> Kembali ke Edukasi
            </Link>
            <motion.h1
              className="text-4xl font-bold text-pinjol-dark-2 mb-4 text-center"
              variants={itemVariants}
            >
              {education.title}
            </motion.h1>
            <motion.div
              className="flex justify-between text-sm text-pinjol-dark-4 mb-6"
              variants={itemVariants}
            >
              <span>
            ...
            <motion.p
              className="text-pinjol-dark-1 leading-relaxed"
              variants={itemVariants}
            >
              {education.content}
            </motion.p>
